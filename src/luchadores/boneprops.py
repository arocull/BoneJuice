...
class Luchadores_BonePanel(bpy.types.Panel):
    ...
    def poll(cls, context: bpy.context):
        return hasattr(context.active_pose_bone, "lmassweight")
...
def define_bone_props():
    ...
    bpy.types.PoseBone.ldrawthickness = FloatProperty(
        name = "Draw Thickness",
    ...
    bpy.types.PoseBone.lmassweight = FloatProperty(
        name = "Mass Weight",
